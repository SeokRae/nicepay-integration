...
@ToString
@NoArgsConstructor
public class SubscribeCreatePgRes {
    ...
    public SubscribeCreatePgRes(String resultCode, String resultMsg, Id<String> orderId, Id<String> tid, Id<String> bid, String authDate, String cardCode, String cardName) {
