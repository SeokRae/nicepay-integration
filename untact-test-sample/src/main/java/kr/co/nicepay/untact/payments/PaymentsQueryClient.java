...
public class PaymentsQueryClient implements PaymentsOutboundQueryPort {
    ...
    @Override
    public Pair<Integer, PaymentsRes> retrieve(
            final Id<String> tid
    ) {
        ...
        ResponseEntity<PaymentsRes> retrievePayments = restTemplate.getForEntity(
    ...
    @Override
    public Pair<Integer, PaymentsRes> retrieveOrderId(
