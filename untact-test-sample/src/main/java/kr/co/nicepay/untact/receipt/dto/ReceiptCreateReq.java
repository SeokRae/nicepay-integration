...
public class ReceiptCreateReq {
    ...
    @Builder
    public ReceiptCreateReq(String orderId, BigDecimal amount, String goodsName, ReceiptType receiptType, String receiptNo, int supplyAmt, int goodsVat, int taxFreeAmt, int serviceAmt, String buyerName, String buyerTel, String buyerEmail, String signData, String returnCharSet) {
